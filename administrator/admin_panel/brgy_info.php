...
<body>
    ...
    <div class = "logo_content">
           ...
           <hr><br>
            ...
            <ul class = "nav_list">
                    ...
                    <li>
                        <a href="brgy_info.php" id = "selected">
        ...
        <div class = "text">
                    ...
                    <div class = "setting">
                        ...
                        <div> <p id = "username_admin">Admin</p>
         ...
         <div id = "content_refresh">
            ...
            <form action="/BIS/administrator/admin_panel/brgy_info_folder/update.php" method = "POST" enctype = "multipart/form-data">
                ...
                <div class = "display_info">
                        ...
                        <input type="file"name="logo" id="logo"  accept = ".jpg, .jpeg, .png"  id = "image" class = "image" >
                       
                </div>
                <div class = "form_info__update">
                    
                    <h1><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M495.9 166.6c3.2 8.7 .5 18.4-6.4 24.6l-43.3 39.4c1.1 8.3 1.7 16.8 1.7 25.4s-.6 17.1-1.7 25.4l43.3 39.4c6.9 6.2 9.6 15.9 6.4 24.6c-4.4 11.9-9.7 23.3-15.8 34.3l-4.7 8.1c-6.6 11-14 21.4-22.1 31.2c-5.9 7.2-15.7 9.6-24.5 6.8l-55.7-17.7c-13.4 10.3-28.2 18.9-44 25.4l-12.5 57.1c-2 9.1-9 16.3-18.2 17.8c-13.8 2.3-28 3.5-42.5 3.5s-28.7-1.2-42.5-3.5c-9.2-1.5-16.2-8.7-18.2-17.8l-12.5-57.1c-15.8-6.5-30.6-15.1-44-25.4L83.1 425.9c-8.8 2.8-18.6 .3-24.5-6.8c-8.1-9.8-15.5-20.2-22.1-31.2l-4.7-8.1c-6.1-11-11.4-22.4-15.8-34.3c-3.2-8.7-.5-18.4 6.4-24.6l43.3-39.4C64.6 273.1 64 264.6 64 256s.6-17.1 1.7-25.4L22.4 191.2c-6.9-6.2-9.6-15.9-6.4-24.6c4.4-11.9 9.7-23.3 15.8-34.3l4.7-8.1c6.6-11 14-21.4 22.1-31.2c5.9-7.2 15.7-9.6 24.5-6.8l55.7 17.7c13.4-10.3 28.2-18.9 44-25.4l12.5-57.1c2-9.1 9-16.3 18.2-17.8C227.3 1.2 241.5 0 256 0s28.7 1.2 42.5 3.5c9.2 1.5 16.2 8.7 18.2 17.8l12.5 57.1c15.8 6.5 30.6 15.1 44 25.4l55.7-17.7c8.8-2.8 18.6-.3 24.5 6.8c8.1 9.8 15.5 20.2 22.1 31.2l4.7 8.1c6.1 11 11.4 22.4 15.8 34.3zM256 336a80 80 0 1 0 0-160 80 80 0 1 0 0 160z"/></svg></span>SETTING</h1>
                        <label for="">Barangay Photo</label><br>
                        <input type="file"name="bg_image" id="bg_image"  accept = ".jpg, .jpeg, .png"  id = "image" class = "image" style = "background-color:white;padding-top:10px;"><br>
                        <label for="" style = "margin-right:35px;" >Barangay</label><br>
                        <input type="text" id="barangay_name" name = "brgy" placeholder = "Ex. Paliparan II"><br>

                        <label for="" style = "margin-right:20px;">Municipality</label><br>
                        <input type="text" id = "municipal"  name = "municipal" placeholder = "Ex. Dasmariñas"><br>

                        <label for="" style = "margin-right:45px;">Address</label><br>
                        <input type="text" id = "address" name = "address" placeholder = "Ex. Address"><br>

                        <label for="" style = "margin-right:35px;">Phone No.</label><br>
                        <input type="tel" id = "phone_no" name = "phone" placeholder = "Ex.09123456789" pattern="[0-9]{11}"><br>

                        <label for="" style = "margin-right:10px;">Email Address</label><br>
 ...
 <form action="./brgy_info_folder/upload.php" method="post" enctype="multipart/form-data" class = "updload_multi">
   
    <div class = "upload_2nd">
    <h1><svg style = "fill:#005720; width:40px; margin-right:20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M256 0L576 0c35.3 0 64 28.7 64 64l0 224c0 35.3-28.7 64-64 64l-320 0c-35.3 0-64-28.7-64-64l0-224c0-35.3 28.7-64 64-64zM476 106.7C471.5 100 464 96 456 96s-15.5 4-20 10.7l-56 84L362.7 169c-4.6-5.7-11.5-9-18.7-9s-14.2 3.3-18.7 9l-64 80c-5.8 7.2-6.9 17.1-2.9 25.4s12.4 13.6 21.6 13.6l80 0 48 0 144 0c8.9 0 17-4.9 21.2-12.7s3.7-17.3-1.2-24.6l-96-144zM336 96a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM64 128l96 0 0 256 0 32c0 17.7 14.3 32 32 32l128 0c17.7 0 32-14.3 32-32l0-32 160 0 0 64c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 192c0-35.3 28.7-64 64-64zm8 64c-8.8 0-16 7.2-16 16l0 16c0 8.8 7.2 16 16 16l16 0c8.8 0 16-7.2 16-16l0-16c0-8.8-7.2-16-16-16l-16 0zm0 104c-8.8 0-16 7.2-16 16l0 16c0 8.8 7.2 16 16 16l16 0c8.8 0 16-7.2 16-16l0-16c0-8.8-7.2-16-16-16l-16 0zm0 104c-8.8 0-16 7.2-16 16l0 16c0 8.8 7.2 16 16 16l16 0c8.8 0 16-7.2 16-16l0-16c0-8.8-7.2-16-16-16l-16 0zm336 16l0 16c0 8.8 7.2 16 16 16l16 0c8.8 0 16-7.2 16-16l0-16c0-8.8-7.2-16-16-16l-16 0c-8.8 0-16 7.2-16 16z"/></svg>GALLERY</h1>
    <div>
        <label>Select multiple images (At least 1, maximum 18 photos):</label>
    ...
    <!-- Array of IDs (Make sure to provide exactly 18 or fewer) -->
